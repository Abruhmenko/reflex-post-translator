...
public class ExpressionUtil {
  ...
  /**
   * static def boolean isHex(PrimaryExpression e) {
   * var String str = NodeModelUtils.getNode(e).text.replaceAll("[+-lLuU]", "").trim
   * //var String str1 = str.replaceAll("+", "").replaceAll("-", "")
   * 
   * return str.startsWith("0x") || str.startsWith("0X")
   * }
   * 
   * static def boolean isOctal(PrimaryExpression e) {
   * var String str = NodeModelUtils.getNode(e).text.replaceAll("+", "").replaceAll("-", "").trim
